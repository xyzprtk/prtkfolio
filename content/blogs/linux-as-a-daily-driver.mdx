...
The first terminal command I ever ran was  
```bash
ls -ah 
```
...
Today, I'm running Arch Linux (yes, I know, "I use Arch btw") with a custom configured hyprland setup. I've got my dotfiles in a git repository, [here](https://github.com/xyzprtk/dotfiles), my workflow is fully keyboard-driven, and I couldn't be happier. The college laptop is now my daily driver for everything—development, coursework, entertainment, and more.
